...
const PodResourcesCard = ({
  ...
  return (
    <Card className={classNames("pod-resources-card", className)}>
      {title && (
        <>
      ...
      <div className="pod-resources-card__section pod-resources-card__ram">
        <div>
        ...
        <table className="pod-resources-card__ram-table">
          <thead>
            <tr>
              <th></th>
      ...
      <div className="pod-resources-card__section pod-resources-card__cpu">
      ...
      <div className="pod-resources-card__section pod-resources-card__vfs">
      ...
      {!title && (
        <div
          className="pod-resources-card__section pod-resources-card__vms"
...
export default PodResourcesCard;
