const docsUrls = {
  ...
  ipRanges: "https://maas.io/docs/how-to-customise-dhcp#p-9038-edit-delete-or-extend-ip-range",
  ...
  tagsAutomatic: "https://maas.io/docs/about-device-labels#p-13973-automatic-tags", 
  tagsKernelOptions:
