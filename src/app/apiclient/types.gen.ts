...
export type DnsResourceRecordSetRequest = {
  ...
  mx_records?: Array<MxRecord>;
  ns_records?: Array<NsRecord>;
  sshfp_records?: Array<SshfpRecord>;
  srv_records?: Array<SrvRecord>;
...
export type SslKeysWithSummaryListResponse = {
  items: Array<SslKeyWithSummaryResponse>;
  total: number;
  next?: string;
  kind?: string;
};
...
export type UsersWithSummaryListResponse = {
  items: Array<UserWithSummaryResponse>;
  total: number;
  next?: string;
  kind?: string;
};
